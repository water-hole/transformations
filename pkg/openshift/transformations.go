...
func UpdateDefaultPullSecrets(u unstructured.Unstructured) jsonpatch.Patch {
...
func UpdateServiceAccount(u unstructured.Unstructured) jsonpatch.Patch {
...
func UpdateRoute(u unstructured.Unstructured) jsonpatch.Patch {
	patchJSON := fmt.Sprintf(`[
